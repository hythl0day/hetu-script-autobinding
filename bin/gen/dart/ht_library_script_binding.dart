...
import 'flutter/material/date_picker_deprecated.g.dart';
...
class HetuLibraryScriptBinding {
  ...
  void loadAutoBindingFunction(Hetu interpreter) {
    ...
    functionWrappers.addAll(DayPickerAutoBinding.functionWrapper());
    functionWrappers.addAll(MonthPickerAutoBinding.functionWrapper());
  ...
  void loadAutoBinding(Hetu interpreter) {
    ...
    var bindings = [
      ...
      DayPickerAutoBinding(),
      MonthPickerAutoBinding(),
      DialogAutoBinding(),
